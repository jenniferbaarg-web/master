...
# ============================================================
# BLOQUE DE CAPTURA DE ERRORES AL INICIO DE LA APLICACIÓN
# ============================================================
try:
    ...
    def emprendimientos():
        try:
            ...
            print("❌ Error en la ruta /emprendimientos:")
            print(traceback.format_exc())
            return "Error interno del servidor", 500
    ...
    def detalle_propiedad(id_propiedad):
        try:
            ...
            print(f"❌ Error en la ruta /propiedad/{id_propiedad}:")
            print(traceback.format_exc())
            return "Error interno del servidor", 500
    ...
    def tasaciones():
        try:
            ...
            print("❌ Error en la ruta /tasaciones:")
            print(traceback.format_exc())
            return "Error interno del servidor", 500
    ...
    def contacto():
        try:
            ...
            print("❌ Error en la ruta /contacto:")
            print(traceback.format_exc())
            return "Error interno del servidor", 500
    ...
    def detalle_emprendimiento(id_propiedad):
        ...
        try:
            ...
            print(f"❌ Error en la ruta /emprendimiento/{id_propiedad}:")
            print(traceback.format_exc())
            return "Error interno del servidor", 500
    ...
    if __name__ == '__main__':
        # En producción (Render) se usa Gunicorn, este bloque solo se ejecuta si se corre python app.py
    ...
    traceback.print_exc()
    print("="*60)
    # Re-lanzar la excepción para que Render la detecte y falle el despliegue
    raise e
